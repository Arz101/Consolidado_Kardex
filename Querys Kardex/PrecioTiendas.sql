...
CREATE TABLE IF NOT EXISTS CONSOLIDADO_KARDEX.dbo.PrecioCompras
(
    id INT IDENTITY(1,1) PRIMARY KEY,
    Sucursal VARCHAR(100),
    Referencia VARCHAR(100),
    CostProm DECIMAL(18,2)
)

ALTER TABLE 

TRUNCATE TABLE CONSOLIDADO_KARDEX.dbo.PrecioCompras
...
WHERE x.FechaUltCompra = CAST(GETDATE() AS DATE)
ORDER BY t0.Orden;